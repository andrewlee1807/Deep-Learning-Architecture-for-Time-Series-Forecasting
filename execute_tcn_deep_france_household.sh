...
do
   ...
   python main.py --dataset_name="FRANCE_HOUSEHOLD_HOUR" --write_log_file=True --model_name="TCN" --config_path="config/france_household_deep_layer.yaml" --output_length=$i --device=0 --output_dir="results/tcn/france_household_deep"
