...
do
   ...
   python main.py --dataset_name="cnu" --write_log_file=True --model_name="Model2" --config_path="config/cnu_model_1.yaml" --output_length=$i --device=0 --output_dir="results/cnu_vanilla_model_2"
