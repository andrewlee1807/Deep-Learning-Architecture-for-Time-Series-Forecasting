...
do
   ...
   python main.py --dataset_name="spain" --write_log_file=True --model_name="Model1" --config_path="config/spain_model_1.yaml" --output_length=$i --device=0 --output_dir="results/spain_vanilla_model_1"
