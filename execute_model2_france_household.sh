...
do
   ...
   python main.py --dataset_name="FRANCE_HOUSEHOLD_HOUR" --write_log_file=True --model_name="Model2" --config_path="config/france_household_model2.yaml" --output_length=$i --device=0 --output_dir="results/france_household_vanilla_model_2"
