...
do
   ...
   python main.py --dataset_name="spain" --write_log_file=True --model_name="TCN" --config_path="config/tcn/spain_deep_layer.yaml" --output_length=$i --device=0 --output_dir="results/tcn/spain_deep"
