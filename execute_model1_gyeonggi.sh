...
do
   ...
   python main.py --dataset_name="gyeonggi" --write_log_file=True --model_name="Model1" --config_path="config/gyeonggi_2955_1_hour.yaml" --output_length=$i --device=0 --output_dir="results"
